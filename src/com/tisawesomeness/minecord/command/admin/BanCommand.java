...
public class BanCommand extends LegacyCommand {
    ...
    public Result run(String[] args, MessageReceivedEvent e) throws Exception {
        ...
        if (args.length < 1) {
            return new Result(Outcome.WARNING, ":warning: Not enough arguments.");
        }
        ...
        if ("user".equals(args[0])) {
            ...
            if (args.length == 1) {
                return new Result(Outcome.WARNING, ":warning: Please define a user.");
            }
            ...
            if (args.length == 1) {
                return new Result(Outcome.WARNING, ":warning: Please define a guild.");
            }
            if (!DiscordUtils.isDiscordId(args[1])) {
                return new Result(Outcome.WARNING, ":warning: Not a valid ID!");
            }
