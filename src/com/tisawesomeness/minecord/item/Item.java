...
public enum Item {
	...
	GOLD_BLOCK(41, "Gold Block", "golden[^0-9A-Z]*block"),
	...
	WOODEN_SWORD(268, "Wooden Sword", "wood[^0-9A-Z]*sword"),
	WOODEN_SHOVEL(269, "Wooden Shovel", "wood[^0-9A-Z]*shovel"),
	
	WOODEN_PICKAXE(270, "Wooden Pickaxe", "wood[^0-9A-Z]*pick(axe)?"),
	WOODEN_AXE(271, "Wooden Axe", "wood[^0-9A-Z]*axe"),
	STONE_SWORD(272, "Stone Sword"),
	STONE_SHOVEL(273, "Stone Shovel"),
	STONE_PICKAXE(274, "Stone Pickaxe", "stone[^0-9A-Z]*pick"),
	STONE_AXE(275, "Stone Axe"),
	DIAMOND_SWORD(276, "Diamond Sword"),
	DIAMOND_SHOVEL(277, "Diamond Shovel"),
	DIAMOND_PICKAXE(278, "Diamond Pickaxe", "diamond[^0-9A-Z]*pick"),
	DIAMOND_AXE(279, "Diamond Axe"),
	
	STICK(280, "Stick"),
	BOWL(281, "Bowl"),
	MUSHROOM_STEW(282, "Mushroom Stew"),
	GOLDEN_SWORD(283, "Golden Sword", "gold[^0-9A-Z]*sword"),
	GOLDEN_SHOVEL(284, "Golden Shovel", "gold[^0-9A-Z]*shovel"),
	GOLDEN_PICKAXE(285, "Golden Pickaxe", "gold[^0-9A-Z]*pick(axe)?"),
	GOLDEN_AXE(286, "Golden Axe"),
	STRING(287, "String"),
	FEATHER(288, "Feather"),
	GUNPOWDER(289, "Gunpowder", "sulphur"),
	
	WOODEN_HOE(290, "Wooden Hoe", "wood[^0-9A-Z]*hoe"),
	STONE_HOE(291, "Stone Hoe"),
	IRON_HOE(292, "Iron Hoe"),
	DIAMOND_HOE(293, "Diamond Hoe"), //srsly
	GOLDEN_HOE(294, "Golden Hoe", "gold[^0-9A-Z]*hoe"),
	...
	GOLDEN_HELMET(314, "Golden Helmet", "gold[^0-9A-Z]*helmet"),
	GOLDEN_CHESTPLATE(315, "Golden Chestplate", "gold[^0-9A-Z]*chestplate"),
	GOLDEN_LEGGINGS(316, "Golden Leggings", "gold[^0-9A-Z]*leggings"),
	GOLDEN_BOOTS(317, "Golden Boots", "gold[^0-9A-Z]*boots"),
	FLINT(318, "Flint"),
	...
	ENCHANTED_GOLDEN_APPLE(322, 1, "Enchanted Golden Apple", "(god[^0-9A-Z]*apple)|(gold(en)?[^0-9A-Z]*apple[ ]*[:;|/.,\\-_~][ ]*1)"), //I actually like that this was removed. Fight me.
	SIGN(323, "Sign"),
	...
	MAP(395, "Empty Map"),
	GOLDEN_CARROT(396, "Golden Carrot", "gold[^0-9A-Z]*carrot"),
	...
	GOLDEN_HORSE_ARMOR(418, "Golden Horse Armor", "gold[^0-9A-Z]*horse[^0-9A-Z]*armor"),
