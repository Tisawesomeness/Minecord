...
public enum Item {
	...
	SPONGE(19, "Sponge"),
	WET_SPONGE(19, 1, "Wet Sponge", "sponge:1", Version.V1_8),
	...
	GRAY_WOOL(35, 7, "Gray Wool", "((35)|(wool)):((gr(a|e)y)|7)"),
	LIGHT_GRAY_WOOL(35, 8, "Light Gray Wool", "((35)|(wool)):((light[^0-9A-Z]*gr(a|e)y)|(silver)|8)"),
	...
	GRAY_STAINED_GLASS(95, 7, "Gray Stained Glass", "((95)|(stained[^0-9A-Z]*glass)):((gr(a|e)y)|7)"),
	LIGHT_GRAY_STAINED_GLASS(95, 8, "Light Gray Stained Glass", "((95)|(stained[^0-9A-Z]*glass)):((light[^0-9A-Z]*gr(a|e)y)|(silver)|8)"),
	...
	ORANGE_STAINED_HARDENED_CLAY(159, 1, "Orange Hardened Clay", "(orange[^0-9A-Z]*(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159))|(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159)):((orange)|(1$)))"),
	MAGENTA_STAINED_HARDENED_CLAY(159, 2, "Magenta Hardened Clay", "(magenta[^0-9A-Z]*(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159))|(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159)):((magenta)|(2$)))"),
	LIGHT_BLUE_STAINED_HARDENED_CLAY(159, 3, "Light Blue Hardened Clay", "(((aqua)|(light[^0-9A-Z]*blue))[^0-9A-Z]*(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159))|((((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159)):((aqua)|(light[^0-9A-Z]*blue)|(3$))))"),
	YELLOW_STAINED_HARDENED_CLAY(159, 4, "Yellow Hardened Clay", "(yellow[^0-9A-Z]*(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159))|(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159)):((yellow)|(4$)))"),
	LIME_STAINED_HARDENED_CLAY(159, 5, "Lime Hardened Clay", "(((lime)|(light[^0-9A-Z]*green))[^0-9A-Z]*(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159))|((((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159)):((lime)|(light[^0-9A-Z]*green)|(3$))))"),
	PINK_STAINED_HARDENED_CLAY(159, 6, "Pink Hardened Clay", "(pink[^0-9A-Z]*(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159))|(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159)):((pink)|6))"),
	GRAY_STAINED_HARDENED_CLAY(159, 7, "Gray Hardened Clay", "(gr(a|e)y[^0-9A-Z]*(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159))|(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159)):((gr(a|e)y)|7))"),
	LIGHT_GRAYSTAINED_HARDENED_CLAY(159, 8, "Light Gray Hardened Clay", "(light[^0-9A-Z]*gr(a|e)y[^0-9A-Z]*(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159))|(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159)):((light[^0-9A-Z]*gr(a|e)y)|(silver)|8))"),
	CYAN_STAINED_HARDENED_CLAY(159, 9, "Cyan Hardened Clay", "(cyan[^0-9A-Z]*(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159))|(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159)):((cyan)|9))"),
	PURPLE_STAINED_HARDENED_CLAY(159, 10, "Purple Hardened Clay", "(purple[^0-9A-Z]*(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159))|(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159)):((purple)|(10)))"),
	BLUE_STAINED_HARDENED_CLAY(159, 11, "Blue Hardened Clay", "(blue[^0-9A-Z]*(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159))|(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159)):((blue)|(11)))"),
	BROWN_STAINED_HARDENED_CLAY(159, 12, "Brown Hardened Clay", "(brown[^0-9A-Z]*(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159))|(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159)):((brown)|(12)))"),
	GREEN_STAINED_HARDENED_CLAY(159, 13, "Green Hardened Clay", "(green[^0-9A-Z]*(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159))|(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159)):((green)|(13)))"),
	RED_STAINED_HARDENED_CLAY(159, 14, "Red Hardened Clay", "(red[^0-9A-Z]*(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159))|(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159)):((red)|(14)))"),
	BLACK_STAINED_HARDENED_CLAY(159, 15, "Black Hardened Clay", "(black[^0-9A-Z]*(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159))|(((hardened)|(stained([^0-9A-Z]*hardened)?))[^0-9A-Z]*clay|(terr?acott?a)|(159)):((black)|(15)))"),
	...
	GRAY_STAINED_GLASS_PANE(160, 7, "Gray Stained Glass Pane", "((160)|(stained[^0-9A-Z]*glass[^0-9A-Z]*pane)):((gr(a|e)y)|7)"),
	LIGHT_GRAYSTAINED_GLASS_PANE(160, 8, "Light Gray Stained Glass Pane", "((160)|(stained[^0-9A-Z]*glass[^0-9A-Z]*pane)):((light[^0-9A-Z]*gr(a|e)y)|(silver)|8)"),
	...
	PRISMARINE_BRICKS(168, 1, "Prismarine Bricks", "prismarine:1", Version.V1_8),
	DARK_PRISMARINE(168, 2, "Dark Prismarine", "prismarine:2", Version.V1_8),
	...
	LIGHT_GRAY_CARPET(171, 8, "Light Gray Carpet", "((171)|(carpet)):((light[^0-9A-Z]*gr(a|e)y)|(silver)|8)"),
	...
	CHISELED_RED_SANDSTONE(179, 1, "Chiseled Red Sandstone", "red[^0-9A-Z]*sandstone:1", Version.V1_8),
	SMOOTH_RED_SANDSTONE(179, 2, "Smooth Red Sandstone", "red[^0-9A-Z]*sandstone:2", Version.V1_8),
	...
	ORANGE_CONCRETE(251, 1, "Orange Concrete", "((251)|(concrete)):((orange)|(1$))", Version.V1_12),
	MAGENTA_CONCRETE(251, 2, "Magenta Concrete", "((251)|(concrete)):((magenta)|(2$))", Version.V1_12),
	LIGHT_BLUE_CONCRETE(251, 3, "Light Blue Concrete", "(aqua[^0-9A-Z]*concrete)|(((251)|(concrete)):((aqua)|(light[^0-9A-Z]*blue)|(3$)))", Version.V1_12),
	YELLOW_CONCRETE(251, 4, "Yellow Concrete", "((251)|(concrete)):((yellow)|(4$))", Version.V1_12),
	LIME_CONCRETE(251, 5, "Lime Concrete", "(light[^0-9A-Z]*green[^0-9A-Z]*concrete)|(((251)|(concrete)):((lime)|(light[^0-9A-Z]*green)|(5$)))", Version.V1_12),
	PINK_CONCRETE(251, 6, "Pink Concrete", "((251)|(concrete)):((pink)|6)", Version.V1_12),
	GRAY_CONCRETE(251, 7, "Gray Concrete", "((251)|(concrete)):((gr(a|e)y)|7)", Version.V1_12),
	LIGHT_GRAY_CONCRETE(251, 8, "Light Gray Concrete", "((251)|(concrete)):((light[^0-9A-Z]*gr(a|e)y)|(silver)|8)", Version.V1_12),
	CYAN_CONCRETE(251, 9, "Cyan Concrete", "((251)|(concrete)):((cyan)|9)", Version.V1_12),
	PURPLE_CONCRETE(251, 10, "Purple Concrete", "((251)|(concrete)):((purple)|(10))", Version.V1_12),
	BLUE_CONCRETE(251, 11, "Blue Concrete", "((251)|(concrete)):((blue)|(11))", Version.V1_12),
	BROWN_CONCRETE(251, 12, "Brown Concrete", "((251)|(concrete)):((brown)|(12))", Version.V1_12),
	GREEN_CONCRETE(251, 13, "Green Concrete", "((251)|(concrete)):((green)|(13))", Version.V1_12),
	RED_CONCRETE(251, 14, "Red Concrete", "((251)|(concrete)):((red)|(14))", Version.V1_12),
	BLACK_CONCRETE(251, 15, "Black Concrete", "((251)|(concrete)):((black)|(15))", Version.V1_12),
	CONCRETE_POWDER(252, "White Concrete Powder", "^concrete[^0-9A-Z]*powder", Version.V1_12),
	ORANGE_CONCRETE_POWDER(252, 1, "Orange Concrete Powder", "((252)|(concrete[^0-9A-Z]*powder)):((orange)|(1$))", Version.V1_12),
	MAGENTA_CONCRETE_POWDER(252, 2, "Magenta Concrete Powder", "((252)|(concrete[^0-9A-Z]*powder)):((magenta)|(2$))", Version.V1_12),
	LIGHT_BLUE_CONCRETE_POWDER(252, 3, "Light Blue Concrete Powder", "(aqua[^0-9A-Z]*concrete[^0-9A-Z]*powder)|(((252)|(concrete[^0-9A-Z]*powder)):((aqua)|(light[^0-9A-Z]*blue)|(3$)))", Version.V1_12),
	YELLOW_CONCRETE_POWDER(252, 4, "Yellow Concrete Powder", "((252)|(concrete[^0-9A-Z]*powder)):((yellow)|(4$))", Version.V1_12),
	LIME_CONCRETE_POWDER(252, 5, "Lime Concrete Powder", "(light[^0-9A-Z]*green[^0-9A-Z]*concrete[^0-9A-Z]*powder)|(((252)|(concrete[^0-9A-Z]*powder)):((lime)|(light[^0-9A-Z]*green)|(5$)))", Version.V1_12),
	PINK_CONCRETE_POWDER(252, 6, "Pink Concrete Powder", "((252)|(concrete[^0-9A-Z]*powder)):((pink)|6)", Version.V1_12),
	GRAY_CONCRETE_POWDER(252, 7, "Gray Concrete Powder", "((252)|(concrete[^0-9A-Z]*powder)):((gr(a|e)y)|7)", Version.V1_12),
	LIGHT_GRAY_CONCRETE_POWDER(252, 8, "Light Gray Concrete Powder", "((252)|(concrete[^0-9A-Z]*powder)):((light[^0-9A-Z]*gr(a|e)y)|(silver)|8)", Version.V1_12),
	CYAN_CONCRETE_POWDER(252, 9, "Cyan Concrete Powder", "((252)|(concrete[^0-9A-Z]*powder)):((cyan)|9)", Version.V1_12),
	PURPLE_CONCRETE_POWDER(252, 10, "Purple Concrete Powder", "((252)|(concrete[^0-9A-Z]*powder)):((purple)|(10))", Version.V1_12),
	BLUE_CONCRETE_POWDER(252, 11, "Blue Concrete Powder", "((252)|(concrete[^0-9A-Z]*powder)):((blue)|(11))", Version.V1_12),
	BROWN_CONCRETE_POWDER(252, 12, "Brown Concrete Powder", "((252)|(concrete[^0-9A-Z]*powder)):((brown)|(12))", Version.V1_12),
	GREEN_CONCRETE_POWDER(252, 13, "Green Concrete Powder", "((252)|(concrete[^0-9A-Z]*powder)):((green)|(13))", Version.V1_12),
	RED_CONCRETE_POWDER(252, 14, "Red Concrete Powder", "((252)|(concrete[^0-9A-Z]*powder)):((red)|(14))", Version.V1_12),
	BLACK_CONCRETE_POWDER(252, 15, "Black Concrete Powder", "((252)|(concrete[^0-9A-Z]*powder)):((black)|(15))", Version.V1_12),
