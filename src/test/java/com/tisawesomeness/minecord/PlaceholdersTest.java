...
public class PlaceholdersTest {
    ...
    private static BotBranding branding = new BotBranding();
    private static BuildInfo buildInfo = BuildInfo.getInstance();
    ...
    public void testPlaceholders(String placeholder, String value) {
        assertThat(Placeholders.parseConstants(placeholder, config, branding)).isEqualTo(value);
    }
    @ParameterizedTest(name = "{index} ==> Placeholder {0} is replaced with {1}")
    ...
    public void testPlaceholdersWithExtra(String placeholder, String value) {
        ...
        String output = ">" + value + "<";
        assertThat(Placeholders.parseConstants(input, config, branding)).isEqualTo(output);
    }
    @Test
    ...
    private static Stream<Arguments> placeholderProvider() {
        return Stream.of(
                ...
                arguments(Placeholders.BOT_SHARDS, String.valueOf(config.getShardCount())),
