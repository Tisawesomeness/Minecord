...
public class RenderTest {
    ...
    public void testRenderAvatar() {
        ...
        Render render = new Render(PlayerTestUtils.STEVE_UUID, type, false);
    ...
    public void testRenderAvatarOverlay() {
        RenderType type = RenderType.AVATAR;
        Render render = new Render(PlayerTestUtils.STEVE_UUID, type, true);
    ...
    public void testRenderAvatarSize() {
        int size = 256;
        RenderType type = RenderType.AVATAR;
        Render render = new Render(PlayerTestUtils.STEVE_UUID, type, false, size);
    ...
    public void testRenderHeadSize() {
        int scale = 3;
        RenderType type = RenderType.HEAD;
        Render render = new Render(PlayerTestUtils.STEVE_UUID, type, false, scale);
    ...
    public void testRenderAvatarOverflow() {
        RenderType type = RenderType.AVATAR;
        Render render = new Render(PlayerTestUtils.STEVE_UUID, type, false, type.getMaxScale() + 1);
        String expected = "https://crafatar.com/avatars/f6489b79-7a9f-49e2-980e-265a05dbc3af?size="
                + type.getMaxScale();
        assertThat(render.render()).hasToString(expected);
    }
