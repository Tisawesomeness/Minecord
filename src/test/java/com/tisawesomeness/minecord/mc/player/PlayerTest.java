...
public class PlayerTest {
    ...
    public void testGetDefaultSkinTypeSteve() {
        Player player = PlayerTests.initPlayerWithDefaultSkin(PlayerTests.STEVE_UUID);
    ...
    public void testGetDefaultSkinTypeAlex() {
        Player player = PlayerTests.initPlayerWithDefaultSkin(PlayerTests.ALEX_UUID);
    ...
    public void testGetSkinTypeSteve() {
        Player player = PlayerTests.initPlayerWithSkinType(PlayerTests.ALEX_UUID, SkinType.STEVE);
        assertThat(player.getSkinType()).isEqualTo(SkinType.STEVE);
    }
    ...
    public void testGetSkinTypeAlex() {
        Player player = PlayerTests.initPlayerWithSkinType(PlayerTests.STEVE_UUID, SkinType.ALEX);
        assertThat(player.getSkinType()).isEqualTo(SkinType.ALEX);
    }
    ...
    public void testCustomSkin() throws URISyntaxException {
        Player player = PlayerTests.initPlayerWithSkinType(PlayerTests.STEVE_UUID, SkinType.STEVE);
    ...
    public void testSteveIsNotCustomSkin() {
        Player player = PlayerTests.initPlayerWithDefaultSkinUrl(PlayerTests.STEVE_UUID, SkinType.STEVE);
    ...
    public void testAlexIsNotCustomSkin() {
        Player player = PlayerTests.initPlayerWithDefaultSkinUrl(PlayerTests.ALEX_UUID, SkinType.ALEX);
        assertThat(player.hasCustomSkin()).isFalse();
    }
    ...
    public void testSteveAlexIsCustomSkin() {
        Player player = PlayerTests.initPlayerWithDefaultSkinUrl(PlayerTests.ALEX_UUID, SkinType.STEVE);
        assertThat(player.hasCustomSkin()).isTrue();
    }
    ...
    public void testAlexSteveIsCustomSkin() {
        Player player = PlayerTests.initPlayerWithDefaultSkinUrl(PlayerTests.STEVE_UUID, SkinType.ALEX);
        assertThat(player.hasCustomSkin()).isTrue();
    }
    ...
    public void testDefaultSteveAndAlexSkins() throws URISyntaxException {
        Player steve = PlayerTests.initPlayerWithDefaultSkin(PlayerTests.STEVE_UUID);
        Player alex = PlayerTests.initPlayerWithDefaultSkin(PlayerTests.ALEX_UUID);
